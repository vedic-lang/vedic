...
# creating dir
rm -rf vedic release dist
mkdir vedic release dist
...
pkg -t node14-linux ./core/main.js --compress GZip --output ./vedic/vedic
...
pkg -t node14-win ./core/main.js --compress GZip --output ./vedic/vedic.exe
zip -r -Z bzip2 ./release/${NAME}_windows.zip . -i ./vedic/vedic.exe

# build macos binary
echo "Building macos binary"
pkg -t node14-mac ./core/main.js --compress GZip --output ./vedic/vedic
